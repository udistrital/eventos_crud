...
func (m *CrearTablaTipoEvento_20191217_160342) Up() {
	...
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.id IS 'Identificador de la tabla tipo sesion';")
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.nombre IS 'Nombre del tipo de sesion';")
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.descripcion IS 'Descripcion del tipo de sesion que se referencia';")
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.codigo_abreviacion IS 'Codigo de abreviación del tipo de sesión que se maneja';")
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.activo IS 'Booleano que define si el tipo de sesión se encuentra actualmente activo o no';")
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.dependencia_id IS 'se referencia al esquema de dependencia del sistema OKIOS';")
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.fecha_creacion IS 'Fecha de creacion de un tipo de evento';")
	m.SQL("COMMENT ON COLUMN eventos.tipo_eventos.fecha_modificacion IS 'Fecha de modifiación de un tipo de evento';")
