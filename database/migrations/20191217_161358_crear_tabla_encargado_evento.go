...
func (m *CrearTablaEncargadoEvento_20191217_161358) Up() {
	...
	m.SQL("COMMENT ON COLUMN eventos.encargado_evento.id IS 'Identificador de la tabla responsable_sesion';")
	m.SQL("COMMENT ON COLUMN eventos.encargado_evento.encargado_id IS 'Se hace referencia al esquema de persona';")
	m.SQL("COMMENT ON COLUMN eventos.encargado_evento.fecha_creacion IS 'Fecha de creacion de un participante del evento';")
