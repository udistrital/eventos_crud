...
func run_bee() {
	parametros := "API_EVENTOS_HTTP_PORT=" + beego.AppConfig.String("httpport") + " EVENTOS_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " EVENTOS_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " EVENTOS_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " EVENTOS_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " EVENTOS_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
